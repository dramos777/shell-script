#!/usr/bin/env bash
#Para debugar um código utilizando o set é necesário colocar set -x no início e no final da
#linha que será debulgada. Neste código abaixo terá um exemplo para checar as ultimas linhas
#VARIABLES
...
#na linha abaixo inicia o debug
set -x
...
set -x
#na linha acima encerra o debug
echo "$USERS"